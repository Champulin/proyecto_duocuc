  ...
  brandData = [
    {
      ...
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [], label: 'Facebook', ...this.colors }]
      }
    },
    {
      icon: 'cibTwitter',
      ...
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [], label: 'Twitter', ...this.colors }]
      }
    },
    {
      icon: 'cib-linkedin',
      ...
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [], label: 'LinkedIn', ...this.colors }]
      }
    },
    {
      icon: 'cilCalendar',
      ...
      data: {
        labels: [...this.labels],
        datasets: [{ ...this.datasets, data: [], label: 'Events', ...this.colors }]
      }
    }
  ];
