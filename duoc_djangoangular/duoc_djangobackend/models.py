...
class ResponsableUnidad(models.Model):
    ...
    id_facultad = models.IntegerField(null=True)
    username = models.CharField(max_length=30, unique=True)
    password = models.CharField(max_length=100)
...
class ProveedoresTelefonia(models.Model):
    ...
    costo_seg_cel = models.IntegerField(default=0)
    costo_seg_ldi = models.IntegerField(default=0)
    costo_seg_slm = models.IntegerField(default=0)
...
class RegistroLlamada(models.Model):
    _id = models.ObjectIdField()
    id_anexo = models.IntegerField(null=True)
    id_facultad = models.IntegerField(null=True)
    id_unidad = models.IntegerField(null=True)
    nombre_proveedor = models.CharField(max_length=50)
    ...
    duracion_llamada = models.IntegerField(default=0)
...
class CalculoMensualUnidad(models.Model):
    ...
    nombre_depto = models.CharField(max_length=50)
    cant_segundos_total = models.IntegerField(default=0)
    cant_segundos_slm = models.IntegerField(default=0)
    cant_segundos_cel = models.IntegerField(default=0)
    cant_segundos_ldi = models.IntegerField(default=0)
    tarificacion_general = models.IntegerField(default=0)
    tarificacion_slm = models.IntegerField(default=0)
    tarificacion_cel = models.IntegerField(default=0)
    tarificacion_ldi = models.IntegerField(default=0)
